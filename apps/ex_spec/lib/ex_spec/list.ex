defmodule ExSpec.List do
  ...
  defimpl ExSpec.Conformable do
    ...
    @spec distinct_problems(ExSpec.t, [term], [ExSpec.Ref.t], [term], term) :: [ConformError.Problem.t]
    ...
    @spec length_problems(@for.t, [term], [ExSpec.Ref.t], [term], term) :: [ConformError.Problem.t]
