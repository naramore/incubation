defmodule ExSpecData do
  ...
  @spec list_of(stream_data, keyword) :: stream_data(ExSpec.List.t)
  ...
  @spec maybe(stream_data, keyword) :: stream_data(ExSpec.Maybe.t)
  ...
  @spec nilable(stream_data, keyword) :: stream_data(ExSpec.Nilable.t)
  ...
  @spec oom(stream_data, keyword) :: stream_data(ExSpec.OneOrMore.t)
  ...
  @spec zom(stream_data, keyword) :: stream_data(ExSpec.ZeroOrMore.t)
  ...
  @spec map_of(stream_data, keyword) :: stream_data(ExSpec.Map.t)
  ...
  @spec also(stream_data, keyword) :: stream_data(ExSpec.Also.t)
  ...
  @spec amp(stream_data, keyword) :: stream_data(ExSpec.Amp.t)
  ...
  @spec list(stream_data, keyword) :: stream_data(ExSpec.List.t)
  ...
  @spec map(stream_data, keyword) :: stream_data(ExSpec.Map.t)
  def map(child_data \\ nil, opts \\ []) do
    data = process(child_data, opts)
    StreamData.map_of(data, data, opts)
  end

  @spec tuple(stream_data, keyword) :: stream_data(ExSpec.Tuple.t)
  ...
  @spec merge(stream_data, keyword) :: stream_data(ExSpec.Merge.t)
  ...
  @spec cat(stream_data, keyword) :: stream_data(ExSpec.Cat.t)
  ...
  @spec alt(stream_data, keyword) :: stream_data(ExSpec.Alt.t)
  ...
  @spec one_of(stream_data, keyword) :: stream_data(ExSpec.OneOf.t)
