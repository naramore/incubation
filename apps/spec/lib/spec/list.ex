defmodule Spec.List do
  ...
  @spec new(Spec.t, non_neg_integer, non_neg_integer | nil, boolean) :: t
  ...
  defimpl Spec.Conformable do
    ...
    @spec distinct_problems(Spec.t, [term], [Spec.Ref.t], [term], term) :: [ConformError.Problem.t]
    ...
    @spec length_problems(@for.t, [term], [Spec.Ref.t], [term], term) :: [ConformError.Problem.t]
