alias Spec.{Also, Alt, Amp, Cat, Keys, Maybe, Merge, Nilable, OneOf, OneOrMore, ZeroOrMore}
defimpl Inspect, for: [
  Also, Alt, Amp, Cat, Keys, Maybe, Merge, Nilable,
  OneOf, OneOrMore, ZeroOrMore, Spec.List, Spec.Map
] do
  @moduledoc false
  ...
  defp inspect_impl("List", %Spec.List{} = spec, opts) do
  ...
  defp inspect_impl("Map", %Spec.Map{} = spec, opts) do
    options = [break: :flex, separator: ","]
    coll =
