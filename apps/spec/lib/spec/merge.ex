defmodule Spec.Merge do
  ...
  @spec new([Spec.merged], (key, value, value -> value)) :: t when key: term, value: term
  ...
  defimpl Spec.Conformable do
    ...
    def conform(%@for{specs: [_|_] = specs} = spec, spec_path, via, value_path, value) when is_map(value) do
        Enum.map(specs, fn s ->
