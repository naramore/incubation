defprotocol Spec.Conformable do
  @moduledoc """
  """
  ...
  @doc """
  """
  @spec conform(t, [term], [Spec.Ref.t], [term], term) :: {:ok, conformed} | {:error, [ConformError.Problem.t]}
  def conform(spec, spec_path, via, value_path, value)
end

defimpl Spec.Conformable, for: Function do
  @moduledoc false

  import Spec.Func, only: [f: 1]
  alias Spec.ConformError
...
defimpl Spec.Conformable, for: List do
  @moduledoc false
  ...
  @spec conform_improper([Spec.t], [term], [Spec.Ref.t], [term], term, position)
  ...
  @spec conform_maybe_improper_tail([Spec.t], [term], [Spec.Ref.t], [term], term, position)
    :: {:ok, term} | {:error, [ConformError.Problem.t]}
...
defimpl Spec.Conformable, for: Tuple do
  @moduledoc false
...
defimpl Spec.Conformable, for: Map do
  @moduledoc false
...
defimpl Spec.Conformable, for: MapSet do
  @moduledoc false
...
defimpl Spec.Conformable, for: Regex do
  @moduledoc false
...
defimpl Spec.Conformable, for: Range do
  @moduledoc false
...
defimpl Spec.Conformable, for: Date.Range do
  @moduledoc false
...
defimpl Spec.Conformable, for: Any do
  @moduledoc false
